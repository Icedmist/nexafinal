...
exports.getDailySummaryEmailTemplate = void 0;
const email_template_1 = require("./email-template");
const NAIRA = "₦";
const fmt = (n) => `${NAIRA}${n.toLocaleString("en-NG", { minimumFractionDigits: 2 })}`;
const getDailySummaryEmailTemplate = (data) => {
  ...
  ` : '';
    ...
    return (0, email_template_1.getBaseEmailTemplate)({
...
exports.getDailySummaryEmailTemplate = getDailySummaryEmailTemplate;
//# sourceMappingURL=daily-summary-template.js.map