...
const SECTORS = [
  ...
  { id: "social_commerce", label: "Online Vendor", icon: Globe, desc: "Instagram shops, social sellers, e-commerce." },
...
const CATEGORY_PRESETS: Record<string, string[]> = {
  ...
  social_commerce: ["Clothing", "Shoes", "Accessories", "Handbags", "Electronics", "Beauty"],
