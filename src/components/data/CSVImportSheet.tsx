...
export function CSVImportSheet({
  ...
  return (
    ...
    >
      <DialogContent className="sm:max-w-[640px] max-h-[90vh] p-0 overflow-hidden nexa-card border-none bg-transparent shadow-none left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
